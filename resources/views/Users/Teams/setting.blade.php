                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="card">
                                        <div class="card-header">Team Owner </div>
                                        <div class="card-body">
                                            ...
                                            <span>
                                                ...
                                                <h5>{{ $user->email }}</h5><span>
                                                    <hr>
                                                    <form method="POST"
                                                        action="{{ route('team.update', Auth::user()->currentTeam->id) }}">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Team Name</label><br>
                                                            <input @if (Auth::user()->currentTeam->user_id != Auth::user()->id) readonly @endif
                                                                required minlength="3" type="text" name="teamName"
                                                                class="form-control"
                                    ...
                                    <div class="col-md-6 col-6">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('team.invite', Auth::user()->currentTeam->id) }}">
                                                    @csrf
                                                    <div class="form-group">
                                ...
                                @if (count($invitees) > 0)
                                    <div class="row">
                                        <div class="col-md-4 col-4">
                                            ...
                                            <p>These people have been invited to your team and have been sent an invitation
                                                email. They may join the team by accepting the email invitation.</p>
                                        </div>
                                        <div class="col-md-6 col-6">
                                            <div class="card">
                                                <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <span class="float float-right text-danger">
                                                                <form class="mr-1" method="POST"
                                                                    action="{{ route('cancel.invite', $invitee->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <span class="float float-right text-danger">
                                                                <form class="mr-1" method="POST"
                                                                    action="{{ route('accept.invite', $invitee->id) }}">
                                                                    @csrf
                                                ...
                                                <div class="card-body">
                                                    @foreach ($userinvitation as $team)
                                                        <div class="form-group">
                                                            ...
                                                            <span class="float float-right text-danger">
                                                                <form class="mr-1" method="POST"
                                                                    action="{{ route('accept.invite', $team->id) }}">
                                                                    @csrf
                                                                    <input class="btn btn-success" type="submit"
                                                                        value="Accept">
                                                                </form>
                            ...
                            @if (count($teamMember) > 0)
                                <div class="row">
                                    <div class="col-md-4 col-4">
                                        <h3>Team Members</h3>
                                        <p>All of the people that are part of this team.</p>
                                    </div>
                                    <div class="col-md-6 col-6">
                                        <div class="card">
                                            <div class="card-body">
                                                    ...
                                                    @foreach ($teamMember as $member)
                                                        <tr>
                                                            ...
                                                            <td style="width:180px">
                                                                <span class="invisible" id="memberID">{{ $member->id }}</span>
                                                                <div class="row">
                                                ...
                                                @foreach ($teamMember as $member)
                                                    <div class="form-group">
                                                        ...
                                                        <span class="float float-right text-danger">
                                                            @if ($member->user_id == Auth::user()->id)
                                                                <form method="POST"
                                                                    action="{{ route('leave.team', $member->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input class="btn btn-danger" type="submit"
                                                                        value="Leave">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="post" action="{{ route('delete.team', Auth::user()->currentTeam->id) }}">
                        @csrf
                        @method('DELETE')
