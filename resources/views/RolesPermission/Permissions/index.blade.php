                                      ...
                                      <td>
                                        <div class="row">
                                            <div class="col-4 col-md-4">
                                              <a href="{{route('permission.edit',$perm->id)}}" class="btn btn-lg btn-primary mr-2" title="Edit {{$perm->name}}" >Edit</a>
                                            </div>
                                          <div class="col-2 col-md-2">
                                            <form method="POST" action="{{route('permission.delete', $perm->id)}}">
                                              @csrf
                                              @method('DELETE')
            ...
            @endif
                            <div class="card-body">
                                <form action="{{ route('permission.store') }}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary btn-block">New Permission</button>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                </form>
